...
export const createTrainingAction = async (prevState: any, formData: FormData): Promise<ActionResponse> => {
  try {
    ...
    return { success: true, message: 'Training created successfully', data: created }
  } catch (error) {
